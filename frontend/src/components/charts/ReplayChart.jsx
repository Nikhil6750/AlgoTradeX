...
const DEFAULT_PALETTE = {
    ...
    upCandle: "#ffffff",
    downCandle: "#7a7a7a",
    upVolume: "rgba(255,255,255,0.2)",
    downVolume: "rgba(160,160,160,0.2)",
    buyMarker: "#ffffff",
    sellMarker: "#a0a0a0",
    exitBuyMarker: "#ffffff",
    exitSellMarker: "#a0a0a0",
...
function ReplayChart({
    ...
    useEffect(() => {
        ...
        const chart = createChart(containerRef.current, {
            ...
            rightPriceScale: { borderColor: palette.border, borderVisible: false, scaleMargins: { top: 0.1, bottom: 0.1 } },
            timeScale: {
